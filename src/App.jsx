    ...
    <div className="min-h-screen bg-[#fbfaf7] text-[#191919] font-sans antialiased selection:bg-[#f1ece4] overflow-x-hidden">
      ...
      <section className="w-full bg-[#fbfaf7] mb-20 md:mb-28 relative overflow-hidden">
        ...
        <div className="relative w-full px-4 md:px-12 select-none">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-4 md:w-5 h-4 md:h-5">
          ...
          <div className="w-full overflow-hidden py-4 px-2">
            ...
            >
              ...
              {graduates.map((grad) => (
                <div 
                  key={`set1-${grad.id}`} 
                  className="w-[270px] md:w-[320px] h-[430px] md:h-[500px] rounded-[2rem] overflow-hidden relative border border-[#e8e2d5] shadow-[0_12px_32px_rgba(40,35,30,0.03)] hover:shadow-[0_30px_70px_rgba(25,25,25,0.15)] hover:border-[#bfae99] hover:-translate-y-2 transition-all duration-500 flex-shrink-0 bg-[#f5f1e9] group"
                >
                  ...
                  <div className="absolute inset-x-3 bottom-3 md:inset-x-4 md:bottom-4 rounded-[1.5rem] bg-black/40 backdrop-blur-md border border-white/10 p-5 md:p-6 text-left flex flex-col justify-end shadow-[0_8px_32px_0_rgba(0,0,0,0.25)] transition-all duration-500 group-hover:bg-black/50 group-hover:border-white/20">
                    ...
                    <h3 className="font-serif text-xl md:text-2xl font-normal text-white mb-2 md:mb-3 tracking-tight leading-tight">
                      {grad.name}
                    </h3>
                    <div className="w-6 h-[1.5px] bg-[#ebdccb]/60 mb-2.5 md:mb-3.5 transition-all duration-500 ease-out group-hover:w-16 group-hover:bg-[#ebdccb]" />
                    <p className="font-serif text-[12px] md:text-[13.5px] text-[#e0deda]/95 italic leading-relaxed line-clamp-3 transition-colors duration-300 group-hover:text-white">
                      "{grad.quote}"
                    </p>
                  </div>
                </div>
